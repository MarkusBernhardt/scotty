...
class ReconciliationCriteriaTest {
    ...
    private static void setAllFilters(ReconciliationCriteria reconciliationCriteria) {
        ...
        reconciliationCriteria.creditorName();
        reconciliationCriteria.creditorIban();
        reconciliationCriteria.creditorBic();
        reconciliationCriteria.creditorId();
        reconciliationCriteria.mandateDate();
        reconciliationCriteria.executionDate();
        reconciliationCriteria.paymentInformationId();
