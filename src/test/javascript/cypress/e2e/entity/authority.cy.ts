...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '9560a701-3017-4dc5-8d49-7cda7c1da83c' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('bf1144ba-0935-4ab2-a7c1-6fb54b219fc0');
      cy.get(`[data-cy="name"]`).should('have.value', 'bf1144ba-0935-4ab2-a7c1-6fb54b219fc0');
