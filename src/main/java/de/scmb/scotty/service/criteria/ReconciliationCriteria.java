...
public class ReconciliationCriteria implements Serializable, Criteria {
    ...
    public ReconciliationCriteria(ReconciliationCriteria other) {
        ...
        this.scottyPaymentId = other.optionalScottyPaymentId().map(LongFilter::copy).orElse(null);
    ...
    public Optional<LongFilter> optionalScottyPaymentId() {
        return Optional.ofNullable(scottyPaymentId);
    }

    public LongFilter scottyPaymentId() {
        if (scottyPaymentId == null) {
            setScottyPaymentId(new LongFilter());
        }
        return scottyPaymentId;
    }
    ...
    public String toString() {
        return "ReconciliationCriteria{" +
            ...
            optionalScottyPaymentId().map(f -> "scottyPaymentId=" + f + ", ").orElse("") +
