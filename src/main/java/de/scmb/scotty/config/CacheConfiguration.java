...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.scmb.scotty.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.scmb.scotty.repository.UserRepository.USERS_BY_EMAIL_CACHE);
