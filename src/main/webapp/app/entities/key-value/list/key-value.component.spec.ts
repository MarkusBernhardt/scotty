...
describe('KeyValue Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'key-value', component: KeyValueComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.keyValues?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to keyValueService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getKeyValueIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getKeyValueIdentifier).toHaveBeenCalledWith(entity);
